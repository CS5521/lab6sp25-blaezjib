...
main(int argc, char * argv[])
{
   ...
   9:	e8 70 03 00 00       	call   37e <fkc>
   e:	89 44 24 08          	mov    %eax,0x8(%esp)
  12:	c7 44 24 04 32 08 00 	movl   $0x832,0x4(%esp)
  19:	00 
  1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  21:	e8 40 04 00 00       	call   466 <printf>

    if(fork() == 0) { //fork once
  26:	e8 a3 02 00 00       	call   2ce <fork>
  2b:	85 c0                	test   %eax,%eax
  2d:	75 05                	jne    34 <main+0x34>
        exit();
  2f:	e8 a2 02 00 00       	call   2d6 <exit>
    }

    if(fork() == 0) { //fork twice
  34:	e8 95 02 00 00       	call   2ce <fork>
  39:	85 c0                	test   %eax,%eax
  3b:	75 05                	jne    42 <main+0x42>
        exit();
  3d:	e8 94 02 00 00       	call   2d6 <exit>
    }

    wait(); // reap the child process
  42:	e8 97 02 00 00       	call   2de <wait>
    wait(); //sold
  47:	e8 92 02 00 00       	call   2de <wait>

     //fkc sys call
    printf(1, "fkc after two forks: %d\n", fkc());
  4c:	e8 2d 03 00 00       	call   37e <fkc>
  51:	89 44 24 08          	mov    %eax,0x8(%esp)
  55:	c7 44 24 04 4c 08 00 	movl   $0x84c,0x4(%esp)
  5c:	00 
  5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  64:	e8 fd 03 00 00       	call   466 <printf>


    exit();
  69:	e8 68 02 00 00       	call   2d6 <exit>
...
stosb(void *addr, int data, int cnt)
{
  ...
  76:	8b 55 10             	mov    0x10(%ebp),%edx
  79:	8b 45 0c             	mov    0xc(%ebp),%eax
  7c:	89 cb                	mov    %ecx,%ebx
  7e:	89 df                	mov    %ebx,%edi
  80:	89 d1                	mov    %edx,%ecx
  82:	fc                   	cld    
  83:	f3 aa                	rep stos %al,%es:(%edi)
  85:	89 ca                	mov    %ecx,%edx
  87:	89 fb                	mov    %edi,%ebx
  89:	89 5d 08             	mov    %ebx,0x8(%ebp)
  8c:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
memset(void *dst, int c, uint n)
{
 ...
 143:	e8 26 ff ff ff       	call   6e <stosb>
  return dst;
...
gets(char *buf, int max)
{
 ...
 1d1:	74 13                	je     1e6 <gets+0x66>
 1d3:	0f b6 45 ef          	movzbl -0x11(%ebp),%eax
 1d7:	3c 0d                	cmp    $0xd,%al
 1d9:	74 0b                	je     1e6 <gets+0x66>
  for(i=0; i+1 < max; ){
 1db:	8b 45 f4             	mov    -0xc(%ebp),%eax
 1de:	83 c0 01             	add    $0x1,%eax
 1e1:	3b 45 0c             	cmp    0xc(%ebp),%eax
 1e4:	7c a9                	jl     18f <gets+0xf>
      break;
  }
  buf[i] = '\0';
...
atoi(const char *s)
{
 ...
 247:	83 ec 10             	sub    $0x10,%esp
  ...
  n = 0;
 24a:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  while('0' <= *s && *s <= '9')
 251:	eb 25                	jmp    278 <atoi+0x34>
    n = n*10 + *s++ - '0';
 ...
 280:	7e 0a                	jle    28c <atoi+0x48>
 282:	8b 45 08             	mov    0x8(%ebp),%eax
 285:	0f b6 00             	movzbl (%eax),%eax
 288:	3c 39                	cmp    $0x39,%al
 28a:	7e c7                	jle    253 <atoi+0xf>
  return n;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ff:	0f b6 80 b0 0a 00 00 	movzbl 0xab0(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 55c:	75 09                	jne    567 <printf+0x101>
          s = "(null)";
 55e:	c7 45 f4 65 08 00 00 	movl   $0x865,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 628:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 6f3:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 6f8:	c9                   	leave  
 6f9:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 719:	e8 40 fc ff ff       	call   35e <sbrk>
 ...
 746:	e8 ce fe ff ff       	call   619 <free>
  return freep;
 74b:	a1 cc 0a 00 00       	mov    0xacc,%eax
}
 750:	c9                   	leave  
 751:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 775:	c7 45 f0 c4 0a 00 00 	movl   $0xac4,-0x10(%ebp)
 77c:	8b 45 f0             	mov    -0x10(%ebp),%eax
 77f:	a3 cc 0a 00 00       	mov    %eax,0xacc
 784:	a1 cc 0a 00 00       	mov    0xacc,%eax
 789:	a3 c4 0a 00 00       	mov    %eax,0xac4
    base.s.size = 0;
 78e:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 795:	00 00 00 
  }
 ...
 7eb:	a3 cc 0a 00 00       	mov    %eax,0xacc
      return (void*)(p + 1);
 ...
 7f6:	eb 38                	jmp    830 <malloc+0xde>
    ...
    if(p == freep)
 7f8:	a1 cc 0a 00 00       	mov    0xacc,%eax
